...
export default function EmojiButton({
    ...
    const btnStyle =
        ...
        selectedCardEntry ? "bg-opacity-90 text-opacity-100 border-sky-200" :
    ...
    return (
        <motion.div whileHover={{ scale: hiddenCardScale }}>
            <button
                className={`${primaryColor} text-black text-4xl font-semibold text-opacity-0 border-2 rounded-md px-1 py-5 w-full h-full transition duration-150 ease-in-out  md:text-6xl lg:px-2 lg:py-8 ${btnStyle} shadow-md shadow-gray-400`}
